...
class User(object):
    ...
    """
    def __init__(self, activated=None, company_id=None, email=None, first_name=None, id=None, lang_key=None, last_name=None, login=None, position=None, profile_image_url=None, reset_date=None, reset_key=None):
        """
